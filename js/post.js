  ...
  try {
    ...
    page.innerHTML = `
      ...
      <section class="post-error">
        ...
        <p>
          This field guide could not be loaded.
        </p>
                        ...
                        (item) => `
                          ...
                          <article>
                            ...
                            <h3>
                              ...
                              <a
                                href="/post.php?post=${encodeURIComponent(
                                  item.slug
                                )}"
                              >
                                ${escapeHTML(
...
function renderPostNotFound(
  ...
  page.innerHTML = `
    ...
    <section class="post-error">
      ...
      <p>
        That field guide does not exist or has moved.
      </p>
